...
export default async function handler(req, res) {
  ...
  const adminEmail = process.env.CONTACT_ADMIN_EMAIL || 'anuragtiwariii@gmail.com';
    ...
    html: `
      ...
      <head>
        ...
        <style>
          ...
          .card {
            ...
            max-width: 600px;
            margin: 0 auto;
            box-shadow: 0 20px 50px rgba(0, 162, 255, 0.15);
          }
          .header {
      ...
      <body>
        <div class="card">
          ...
          <div class="value">
            <a href="mailto:${user_email}" style="color: #00a2ff; text-decoration: none; border-bottom: 1px dashed #00a2ff;">
              ${user_email}
            </a>
          </div>
          ...
          <div class="footer">
            Sent from Anurag Tiwari's Portfolio System • ${new Date().toLocaleString()}
          </div>
        </div>
      </body>
      </html>
