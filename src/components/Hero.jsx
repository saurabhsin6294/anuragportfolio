      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="relative mt-8 md:mt-0 self-start md:self-auto">
          ...
          >
            ...
            <div className="w-7 h-7 rounded-full bg-[#00a2ff] text-white flex justify-center items-center shadow-[0_2px_8px_rgba(0,162,255,0.4)] group-hover:scale-110 transition-transform duration-300">
              {!isPlaying || isMuted ? (
                // Play Icon
