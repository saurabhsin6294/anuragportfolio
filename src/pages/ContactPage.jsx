...
const ContactPage = () => {
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-white pt-32 pb-24 px-6 md:px-12 font-sans relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-10 w-96 h-96 bg-blue-800/5 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="mb-16">
          ...
          >
            CONTACT <span className="text-[#00a2ff]">ME.</span>
          </motion.h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-16 mb-24">
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="flex flex-col gap-2">
                  ...
                  <input 
                    ...
                    id="firstName" 
                    placeholder="Anurag"
                    className="w-full bg-transparent border-b border-white/20 pb-2 text-base focus:outline-none focus:border-[#00a2ff] transition-colors placeholder-white/20 font-medium"
                  />
                </div>
                <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col gap-2">
                ...
                <input 
                  type="email" 
                  id="email" 
                  placeholder="anuragtiwariii@gmail.com"
                  className="w-full bg-transparent border-b border-white/20 pb-2 text-base focus:outline-none focus:border-[#00a2ff] transition-colors placeholder-white/20 font-medium"
                />
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea 
                  ...
                  rows={4}
                  className="w-full bg-transparent border-b border-white/20 pb-2 text-base focus:outline-none focus:border-[#00a2ff] transition-colors placeholder-white/20 font-medium resize-none"
                ></textarea>
              </div>
              ...
              <div className="flex items-start gap-3 pt-2">
                <input 
                  type="checkbox" 
                  id="permission" 
                  className="mt-1 w-4 h-4 rounded-sm border-white/20 bg-transparent text-[#00a2ff] focus:ring-[#00a2ff] focus:ring-offset-0 focus:ring-offset-transparent cursor-pointer" 
                  style={{ accentColor: "#00a2ff" }}
                />
              ...
              {status === 'error' && errorMsg && (
                <motion.div 
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  className="bg-black/40 border border-white/10 text-sky-200 px-4 py-2.5 rounded-xl font-bold text-xs shadow-md flex items-center gap-2.5 w-full"
                >
          ...
          <div className="lg:col-span-2 space-y-8 flex flex-col justify-between">
            {/* Quick Details Card */}
            <div className="bg-white/5 border border-white/10 rounded-3xl p-8 hover:border-sky-500/20 transition-all duration-300 shadow-xl flex-1 flex flex-col justify-between">
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <a href={`mailto:${personalInfo.emails.primary}`} className="text-white hover:text-[#00a2ff] text-base font-bold transition-colors">
                  ...
                  <div>
                    ...
                    <a href={`tel:${personalInfo.phone.replace(/\s+/g, '')}`} className="text-white hover:text-[#00a2ff] text-base font-bold transition-colors">
                      {personalInfo.phone}
                    </a>
                  </div>
                </div>
              ...
              <div className="flex gap-4 pt-6 border-t border-white/10 mt-6">
                <a 
                  ...
                  className="px-4 py-2 bg-white/5 border border-white/10 rounded-xl text-xs font-bold transition-colors"
                >
                  LinkedIn
                </a>
                <a 
            ...
            {/* Location Card */}
            <div className="bg-white/5 border border-white/10 rounded-3xl p-8 hover:border-sky-500/20 transition-all duration-300 shadow-xl relative overflow-hidden group min-h-[180px]">
              ...
              <p className="text-white/60 text-sm leading-relaxed mb-4 z-10 relative">
                Tiwariganj, Lucknow 226028, Uttar Pradesh, India <br />
              ...
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/5 rounded-full border border-white/10 text-xs font-mono font-bold z-10 relative">
                <span className="w-2 h-2 rounded-full bg-[#00a2ff] animate-pulse"></span>
                GMT +5:30 Time Zone
              </div>
            </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {faqs.map((faq, idx) => (
              <div 
                key={idx}
                className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:border-sky-500/20 transition-all duration-300"
              >
                <h3 className="text-white text-lg font-bold mb-3 flex gap-2">
                  <span className="text-[#00a2ff]">Q.</span>
                  {faq.q}
                </h3>
      ...
      <AnimatePresence>
        {status === 'error' && errorMsg && (
          <motion.div
            ...
            className="fixed bottom-8 right-8 left-8 md:left-auto md:w-96 z-[99999] bg-black/95 backdrop-blur-md border border-sky-500/30 text-white px-6 py-4 rounded-2xl shadow-[0_10px_30px_rgba(0,162,255,0.25)] flex items-center gap-4"
          >
            <div className="w-8 h-8 rounded-full bg-sky-500/20 text-sky-500 flex items-center justify-center font-bold text-lg shrink-0">
              ⚠️
            </div>
            <div>
              <h4 className="font-black text-sm text-sky-400 uppercase tracking-wider">Validation Error</h4>
